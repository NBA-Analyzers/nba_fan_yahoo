...
class AgentAPI:
    ...
    def __init__(self, agent_manager: AgentManager):
        ...
        self.vector_store_id = "vs_68d28df1db1081919589f7dcbb4df3c3"  # Default vector store ID
...
async def chat_with_openai(request: ChatRequest):
    ...
    # Start new chat
    if request.session_id not in [session.session_id for session in agent_api.currently_open_chat_sessions]:
