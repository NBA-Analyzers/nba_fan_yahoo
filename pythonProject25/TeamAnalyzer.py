...
class TeamAnalyzer:
    ...
    def pg_avg_stats_team(self, season_stats, count=0):
    ...
    def pg_player_stats(self, season_stats):
        stats = self.pg_avg_stats_team(season_stats)
        pg_play_stats = pd.DataFrame(stats / self.length_team)
