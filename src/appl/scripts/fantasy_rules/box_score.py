...
def get_season_games(season='2025-26'):
...
if __name__ == "__main__":
    games_df = get_season_games('2025-26')
    # sample_games = get_sample_games()
    box_scores = get_all_box_scores(games_df)
    save_to_json(box_scores, 'nba_2025_26_box_scores.json')
